...
class Board {
    ...
    kingPosition(color) {
        return this.board
            .flat()
            .find(piece => (piece === null || piece === void 0 ? void 0 : piece.name) === 'king' && piece.color === color)
            .pos;
    }
    pieces(color) {
        return this.board
    ...
    kingAttackingPieces(color) {
        return this.pieces(color)
            .filter(piece => this.kingPosition((0, utils_1.opponent)(color)).in(piece.validMoves(this)));
    }
    ...
    inCheck(color) {
        ...
        return this.pieces((0, utils_1.opponent)(color))
            .some(piece => kingPos.in(piece.controlledSquares(this)));
    }
    controlledSquares(color) {
        return (0, lodash_1.uniqWith)(this.pieces(color)
            .flatMap(piece => piece.controlledSquares(this)), (a, b) => a.equals(b));
    }
