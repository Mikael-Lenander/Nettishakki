...
describe('The Pos class', () => {
    describe('squaresBetween method', () => {
        test('returns correct Pos instances when positions are on the same diagonal', () => {
            ...
            expect(tests[0]).toEqual((0, testHelpers_1.extractPos)([
                [3, 4],
                [4, 5]
            ]));
            expect(tests[1]).toEqual((0, testHelpers_1.extractPos)([
                [1, 5],
                [2, 4],
                [3, 3]
            ]));
        ...
        test('returns correct Pos instances when positions are on the same rank', () => {
            const tests = [(0, testHelpers_1.sortPosArr)(new Pos_1.default(0, 0).squaresBetween(new Pos_1.default(7, 0))), (0, testHelpers_1.sortPosArr)(new Pos_1.default(4, 6).squaresBetween(new Pos_1.default(4, 6)))];
            expect(tests[0]).toEqual((0, testHelpers_1.extractPos)([
                [1, 0],
                [2, 0],
                [3, 0],
